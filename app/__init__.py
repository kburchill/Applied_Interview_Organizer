...
from .api.companies_routes import company_routes
from .api.interviews_routes import interview_routes
from .api.applications_routes import application_routes
